...
define view entity zm_proj_booking as projection on zm_i_booking
{
@UI.facet: [{ id:'Booking',
purpose:#STANDARD,
...
purpose:#STANDARD,
 ...
 @UI.identification: [{position:90}]
    ...
    lastchangedat,
    /* Associations */
    _BOOKINGSUPPL : redirected to composition child zm_proj_bookingsuppl,
    _carrier,
    _connection,
    _customer,
    _travel : redirected to parent zm_proj_travel
}
